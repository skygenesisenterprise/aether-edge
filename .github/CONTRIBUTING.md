...
# Contributing to Aether Edge

Thank you for your interest in contributing to **Aether Edge**!  
...
**Aether Edge** is the official Aether Edge of Sky Genesis Enterprise, licensed under **Apache 2.0**, with both:
...
We follow a [Code of Conduct](https://github.com/skygenesisenterprise/aether-edge/CODE_OF_CONDUCT.md) to ensure a safe, respectful, and inclusive environment.  
